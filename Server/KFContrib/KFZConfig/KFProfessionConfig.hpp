...
namespace KFrame
{
    ...
    public:
        // 是否有效( 被限制 )
        bool IsValid( uint32 race, uint32 movetype, uint32 weapontype ) const;
    ...
    ////////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////
    class KFProfessionConfig : public KFIntConfigT< KFProfessionSetting >, public KFInstance< KFProfessionConfig >
    {
    public:
        KFProfessionConfig()
        {
