...
namespace KFrame
{
    ...
    public:
        ...
        // 背景限制
        std::set< uint32 > _background_list;

        // 职业限制
        std::set< uint32 > _profession_list;
    ...
    ////////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////
    class KFCharacterConfig : public KFIntConfigT< KFCharacterSetting >, public KFInstance< KFCharacterConfig >
    {
    public:
        KFCharacterConfig()
        {
