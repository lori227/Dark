...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_EnumMessage_2eproto 
...
enum HeroPosEnum {
  ...
  HeroTeam = 1,
  TrainCamp = 2,
  HeroPosEnum_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  HeroPosEnum_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool HeroPosEnum_IsValid(int value);
const HeroPosEnum HeroPosEnum_MIN = HeroList;
const HeroPosEnum HeroPosEnum_MAX = TrainCamp;
const int HeroPosEnum_ARRAYSIZE = HeroPosEnum_MAX + 1;

const ::google::protobuf::EnumDescriptor* HeroPosEnum_descriptor();
inline const ::std::string& HeroPosEnum_Name(HeroPosEnum value) {
  return ::google::protobuf::internal::NameOfEnum(
    HeroPosEnum_descriptor(), value);
}
inline bool HeroPosEnum_Parse(
    const ::std::string& name, HeroPosEnum* value) {
  return ::google::protobuf::internal::ParseNamedEnum<HeroPosEnum>(
    HeroPosEnum_descriptor(), name, value);
}
enum HeroLockEnum {
  NoLock = 0,
  HeroListLock = 1,
...
const BuildEnum BuildEnum_MAX = MaxBuild;
...
const RecordEnum RecordEnum_MAX = DailyRecord;
...
const NoticeEnumEx NoticeEnumEx_MAX = NoticeDailyRecord;
...
template <> struct is_proto_enum< ::KFMsg::HeroPosEnum> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::KFMsg::HeroPosEnum>() {
  return ::KFMsg::HeroPosEnum_descriptor();
}
