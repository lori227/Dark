...
class S2SDelRecordReq;
class S2SDelRecordReqDefaultTypeInternal;
LIBPROTOC_EXPORT extern S2SDelRecordReqDefaultTypeInternal _S2SDelRecordReq_default_instance_;
...
template<> LIBPROTOC_EXPORT ::KFMsg::S2SDelRecordReq* Arena::CreateMaybeMessage<::KFMsg::S2SDelRecordReq>(Arena*);
...
const ServerProtocol ServerProtocol_MAX = S2S_DEL_RECORD_REQ;
...
class LIBPROTOC_EXPORT S2SAddRecordReq : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:KFMsg.S2SAddRecordReq) */ {
 public:
  ...
  private:
  const ::KFMsg::PBValues& _internal_pbrecord() const;
  public:
  const ::KFMsg::PBValues& pbrecord() const;
  ::KFMsg::PBValues* release_pbrecord();
  ::KFMsg::PBValues* mutable_pbrecord();
  void set_allocated_pbrecord(::KFMsg::PBValues* pbrecord);
...
class LIBPROTOC_EXPORT S2SDelRecordReq : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:KFMsg.S2SDelRecordReq) */ {
 public:
  S2SDelRecordReq();
  virtual ~S2SDelRecordReq();

  S2SDelRecordReq(const S2SDelRecordReq& from);

  inline S2SDelRecordReq& operator=(const S2SDelRecordReq& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  S2SDelRecordReq(S2SDelRecordReq&& from) noexcept
    : S2SDelRecordReq() {
    *this = ::std::move(from);
  }

  inline S2SDelRecordReq& operator=(S2SDelRecordReq&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  #endif
  static const ::google::protobuf::Descriptor* descriptor();
  static const S2SDelRecordReq& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const S2SDelRecordReq* internal_default_instance() {
    return reinterpret_cast<const S2SDelRecordReq*>(
               &_S2SDelRecordReq_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    24;

  void Swap(S2SDelRecordReq* other);
  friend void swap(S2SDelRecordReq& a, S2SDelRecordReq& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline S2SDelRecordReq* New() const final {
    return CreateMaybeMessage<S2SDelRecordReq>(NULL);
  }

  S2SDelRecordReq* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<S2SDelRecordReq>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
  void CopyFrom(const S2SDelRecordReq& from);
  void MergeFrom(const S2SDelRecordReq& from);
  void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(S2SDelRecordReq* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  // @@protoc_insertion_point(class_scope:KFMsg.S2SDelRecordReq)
 private:
...
inline const ::KFMsg::PBValues& S2SAddRecordReq::_internal_pbrecord() const {
  return *pbrecord_;
}
inline const ::KFMsg::PBValues& S2SAddRecordReq::pbrecord() const {
  const ::KFMsg::PBValues* p = pbrecord_;
  // @@protoc_insertion_point(field_get:KFMsg.S2SAddRecordReq.pbrecord)
  return p != NULL ? *p : *reinterpret_cast<const ::KFMsg::PBValues*>(
      &::KFMsg::_PBValues_default_instance_);
}
inline ::KFMsg::PBValues* S2SAddRecordReq::release_pbrecord() {
  // @@protoc_insertion_point(field_release:KFMsg.S2SAddRecordReq.pbrecord)
  
  ::KFMsg::PBValues* temp = pbrecord_;
  pbrecord_ = NULL;
  return temp;
}
inline ::KFMsg::PBValues* S2SAddRecordReq::mutable_pbrecord() {
  
  if (pbrecord_ == NULL) {
    auto* p = CreateMaybeMessage<::KFMsg::PBValues>(GetArenaNoVirtual());
    pbrecord_ = p;
  }
  // @@protoc_insertion_point(field_mutable:KFMsg.S2SAddRecordReq.pbrecord)
  return pbrecord_;
}
inline void S2SAddRecordReq::set_allocated_pbrecord(::KFMsg::PBValues* pbrecord) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
...
// uint64 id = 1;
inline void S2SQueryRecordReq::clear_id() {
  id_ = GOOGLE_ULONGLONG(0);
}
inline ::google::protobuf::uint64 S2SQueryRecordReq::id() const {
  // @@protoc_insertion_point(field_get:KFMsg.S2SQueryRecordReq.id)
  return id_;
}
inline void S2SQueryRecordReq::set_id(::google::protobuf::uint64 value) {
  
  id_ = value;
  // @@protoc_insertion_point(field_set:KFMsg.S2SQueryRecordReq.id)
}
...
// uint64 id = 1;
inline void S2SDelRecordReq::clear_id() {
  id_ = GOOGLE_ULONGLONG(0);
}
inline ::google::protobuf::uint64 S2SDelRecordReq::id() const {
  // @@protoc_insertion_point(field_get:KFMsg.S2SDelRecordReq.id)
  return id_;
}
inline void S2SDelRecordReq::set_id(::google::protobuf::uint64 value) {
  
  id_ = value;
  // @@protoc_insertion_point(field_set:KFMsg.S2SDelRecordReq.id)
}

// uint32 type = 2;
inline void S2SDelRecordReq::clear_type() {
  type_ = 0u;
}
inline ::google::protobuf::uint32 S2SDelRecordReq::type() const {
  // @@protoc_insertion_point(field_get:KFMsg.S2SDelRecordReq.type)
  return type_;
}
inline void S2SDelRecordReq::set_type(::google::protobuf::uint32 value) {
  
  type_ = value;
  // @@protoc_insertion_point(field_set:KFMsg.S2SDelRecordReq.type)
}
